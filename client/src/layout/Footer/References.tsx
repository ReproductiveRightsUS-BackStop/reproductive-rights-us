...
export default function References() {
    ...
    return (
        <>
            <div className="w-full m-0 p-2 lg:p-6">
            ...
            <div className="bg-blue-300 w-full m-0">
                <p className="m-2 p-2 text-center">Re-created by Kirabo for Borrowed Lines Media. &copy;2025</p>
            </div>
